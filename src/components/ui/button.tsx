...
const button = cva(
  'inline-flex items-center justify-center gap-2 rounded-chip border font-medium transition-colors ' +
    'disabled:pointer-events-none disabled:opacity-45 [&_svg]:size-3.5 [&_svg]:shrink-0 cursor-pointer',
  {
    variants: {
      variant: {
        default: 'bg-panel2 border-line2 text-fg hover:bg-panel3 hover:border-dim2',
        quiet: 'bg-panel border-line text-dim hover:text-fg hover:bg-panel2 hover:border-line2',
